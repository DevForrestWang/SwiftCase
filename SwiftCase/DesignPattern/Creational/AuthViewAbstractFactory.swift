...
class StudentAuthViewFactory: AuthViewFactory {
    static func authView(for type: AuthType) -> AuthView {
        SC.log("Student View has been created")
        switch type {
        case .login:
    ...
    static func authController(for type: AuthType) -> AuthViewController {
        ...
        SC.log("Student View Controller has been created")
        return controller
    }
}
...
class TeacherAuthViewFactory: AuthViewFactory {
    static func authView(for type: AuthType) -> AuthView {
        SC.log("Teacher View has been created")
        switch type {
        case .login:
    ...
    static func authController(for type: AuthType) -> AuthViewController {
        ...
        SC.log("Teacher View Controller has been created")
        return controller
    }
}
