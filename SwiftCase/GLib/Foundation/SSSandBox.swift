//
//===--- SCSandbox.swift - Defines the SCSandbox class ----------===//
//
...
import UIKit
@objcMembers
open class SCSandbox: NSObject {
    public static let shared = SCSandbox()
    ...
    public static var cachePath: String {
        return SCSandbox.shared.cachesDirectory + "/" + "SSCache"
    }

    /// 图片缓存路径
    public static var cacheImgPath: String {
        return SCSandbox.shared.cachesDirectory + "/" + "SSCache" + "/" + "Img/"
    }

    /// API缓存路径
    public static var cacheAPIPath: String {
        return SCSandbox.shared.cachesDirectory + "/" + "SSCache" + "/" + "API/"
    }
}
